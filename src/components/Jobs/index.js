...
class Jobs extends Component {
  ...
  getTheJobsList = async () => {
    ...
    if (response.ok) {
      ...
      this.setState({
        jobsList,
        isLoading: false,
        JobsListLoading: 'SUCCESS',
      })
    } else {
      this.setState({
        isLoading: false,
        JobsListLoading: 'FAILURE',
      })
    }
  }
  ...
  renderProductsList = () => {
    const {JobsListLoading, jobsList} = this.state

    switch (JobsListLoading) {
      case 'SUCCESS':
        return (
          <div>
            <ul>
        ...
        <div className="jobsBg">
          <div>
            ...
            <form className="filtersSection">
              <div>
                <h1 className="filterHeadings">Type of Employment</h1>
                <input
                  type="checkbox"
                  id="fullTime"
                  name="fullTime"
              ...
              <hr />
              <div>
                <h1 className="filterHeadings">Salary Range</h1>
                <input
                  type="radio"
                  id="10LPA"
                  name="LPA"
          ...
          <div>
            ...
            {isLoading ? (
              <div className="loader-container JobsLoader" data-testid="loader">
                <Loader
                  type="ThreeDots"
                  color="#ffffff"
                  height="50"
